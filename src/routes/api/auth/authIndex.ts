...
import {createUser, showUserByFirstNameAndLastName, User} from '../../../models/user/user.js';
...
authRouter.post('/register', async (req: Request, res: Response) => {
    ...
    try{
        const existingUser: User = await showUserByFirstNameAndLastName(first_name, last_name);
        if(existingUser){
